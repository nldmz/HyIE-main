...
class HyIE(BaseClass):
    ...
    def __init__(self, dataset, emb_dim, emb_dim1):
        ...
        self.forwardmamba = Mamba(mambaargs)
    ...
    def getrelandposinfo(self,r,batchents):
        ...
        if batchents.shape[1] == 2:
            #mamba
            rever_batchents = batchents.flip(dims=[1])
            forwardent = self.forwardmamba(rever_batchents, r2mamba)
            backwardent = self.mamba(batchents, r2mamba)
            outents = backwardent + forwardent
